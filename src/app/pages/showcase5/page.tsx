    ...
    <div className={`${isDark ? 'dark bg-[#020617] text-slate-100' : 'bg-slate-50 text-slate-900'} min-h-screen transition-colors duration-500  relative overflow-hidden font-sans`}>
     ...
     {/* 1. STUDENTIFY content - ALIGN RIGHT */}
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex flex-col lg:items-end items-start text-left lg:text-right"
      >
...
{/* 2. TEACHERFY  content- ALIGN LEFT */}
      ...
      <motion.div
        ...
        className= {`relative rounded-[2rem] p-6 bg-white/5 backdrop-blur-xl border border-white/10  ${isDark ? "text-gray-400" : "text-white/40"} text-white shadow-2xl h-full flex flex-col group `}
      >
